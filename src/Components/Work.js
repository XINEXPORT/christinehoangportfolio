  ...
  return (
    <article className="pt-8 border-b-2 border-dark-content pb-5 border-opacity-20">
      <div className="flex justify-between items-center">
        <h1 className="text-black md:text-lg lg:text-xl">{position}</h1>
        <div
      ...
      <div className="flex justify-between pt-2">
        <div className="flex flex-col md:flex-row">
          <div className="flex items-center pr-5">
            <svg
              className="fill-black min-w-fit"
              width="16"
              height="12"
              viewBox="0 0 16 12"
              fill="none"
        ...
        <p className="text-black text-xs md:text-sm font-light pl-1 min-w-fit">
          {duration}
        </p>
      </div>
    </article>
