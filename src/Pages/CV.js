        ...
        <div className="flex items-center justify-center h-screen w-screen">
            {loadError ? (
                <div className="text-center">
                    <h1 className="text-xl font-bold text-red-600">Error Loading Document</h1>
                    <p className="text-gray-600">The document could not be loaded. Please try viewing the document on desktop.</p>
                </div>
            ) : (
                <iframe 
